...
chip_dict = {
	'kmer1' : ['seq1','seq3','seq9'],
	'kmer2' : ['seq2','seq3','seq4','seq9'],
	'kmer3' : ['seq4','seq5','seq6','seq7','seq9'],
	'kmer4' : ['seq2','seq7','seq8','seq9']
	}
seq_sample = (['seq1'] * 100000) + (['seq2'] * 100000) + (['seq3'] * 200000) + (['seq4'] * 1000000) + (['seq5'] * 100000) + (['seq6'] * 400000) + (['seq7'] * 800000) + (['seq8'] * 300000) + (['seq9'] * 100000)
chip_size = 2000
trials = 10
